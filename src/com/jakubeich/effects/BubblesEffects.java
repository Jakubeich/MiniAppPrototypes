...
class Surface extends JPanel implements ActionListener {
	...
	private final Color colors[] = { Color.blue, Color.cyan, Color.green, Color.magenta, Color.orange, Color.pink,
...
public class BubblesEffects extends JFrame {

	public BubblesEffects() {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				...
				BubblesEffects ex = new BubblesEffects();
				ex.setVisible(true);
			}
		});
	}
